...
Assessments will include: active participation in lectures & design studios (10%), a portfolio design project (10%), coding assignments and _viva voce_ code explanations (10%), and three exams (two midterms & one final: 60%). All deadlines are given in PT.  
...
Updated final submission instructions coming shortly
